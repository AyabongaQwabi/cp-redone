  ...
  return (
    ...
    >
      <div className="p-4 flex items-center justify-between border-b border-red-800">
        ...
        <button onClick={() => setIsCollapsed(!isCollapsed)} className="p-2 rounded-full hover:bg-red-800">
        ...
        <ul className="space-y-2 p-2">
          {adminSidebarItems.map((item) => (
            <li key={item.href}>
              ...
              >
                <item.icon className={cn("h-6 w-6", isCollapsed && "text-white hover:text-red-300")} />
      ...
      <div className="p-4 border-t border-red-800">
        ...
        >
          <LogOut className={cn("h-6 w-6", isCollapsed && "text-white hover:text-red-300")} />
